				...
				// alert(user);
				 google.maps.event.addListener(map, 'click', function(event) {
					...
					google.maps.event.addListener(marker, 'click', function() {
					  ...
					  infowindow.setContent("<body bgcolor=yellow><form name=f1 action=temp.php?user="+user+" method=post>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Title:&nbsp;&nbsp;<input size=27 type=text name=title><br>Description:&nbsp;&nbsp;<textarea cols=35 style='vertical-align:sub;' rows=6 name=desc></textarea><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Date:&nbsp;&nbsp;<input type=text size=27 name=date><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Link:&nbsp;&nbsp;<input type=text size=27 name=link><input type=hidden name=zoomlvl value="+map.getZoom()+"><input type=hidden name=lat value=" + marker.position.lat().toString() + " /> <input type=hidden name=lng value="+marker.position.lng().toString()+"> <br><br><input type=submit value=submit>&nbsp;&nbsp;<input type=reset value=Clear>&nbsp;&nbsp;<a href=temp.php?arg=true'>Delete</a></form></body>");
